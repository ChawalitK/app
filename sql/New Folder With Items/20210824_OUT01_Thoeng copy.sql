with      
     analog_transition_kvab as (     
         ...
         where ant."KeyTag" IN (12460000)     
         and ant."Timestamp" >= '2021-02-01 00:00:00'       
         and ant."Timestamp" <= '2021-02-01 23:59:59.999'
     ...
     timeseries as (     
         select      
         (select '2021-02-01'::date - INTERVAL '30 MIN' ) + ( n || ' minutes')::interval start_time      
     ...
     result_records as (     
		 ...
		 where ts.start_time >= '2021-02-01 00:00:00' and ts.start_time <= '2021-02-01 23:59:59.999'
