            ...
            query_cmd = 'with ' \
                    ...
                    '    and ant."Timestamp" >= \''+report_date+' 00:00:00\'  ' \
                    '    and ant."Timestamp" <= \''+report_date+' 23:59:59\' ' \
                    ...
                    ' full join timeseries ts on rr.start_time::timestamp WITHOUT TIME ZONE = ts.start_time  where ts.start_time >= \''+report_date+' 00:00:00\'' \
                    ' and ts.start_time <= \''+report_date+' 23:59:59\' order by ts.start_time ASC'
